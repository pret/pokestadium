...
void func_86300154(void) {
    ...
    D_86301718->unk_0B4 = 0.0f;
    D_86301718->unk_0B8 = 70.0f;
    D_86301718->unk_0BC = 0.0f;
...
void func_86301234(void) {
    ...
    for (i = 0; i < 4; i++) {
        ...
        func_8001BC34(D_86301D48, 0, 0x27, D_86301710->unk_08[0]->unk_00);
    ...
    func_8001BB58(D_86301D48);
    func_8001BC34(D_86301D48, 0, 0x9A, D_86301710->unk_08[0]->unk_00);
